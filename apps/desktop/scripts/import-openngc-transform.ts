...
const OBJECT_TYPE_MAPPING: Record<
  OpenNgcObjectType,
  { viewMode: 'star'; recommendedFilter: FilterPosition }
> = {
  G: { viewMode: 'star', recommendedFilter: 'clear' },
  GPair: { viewMode: 'star', recommendedFilter: 'clear' },
  GTrpl: { viewMode: 'star', recommendedFilter: 'clear' },
  GGroup: { viewMode: 'star', recommendedFilter: 'clear' },
  OCl: { viewMode: 'star', recommendedFilter: 'clear' },
  GCl: { viewMode: 'star', recommendedFilter: 'clear' },
  'Cl+N': { viewMode: 'star', recommendedFilter: 'lp' },
  PN: { viewMode: 'star', recommendedFilter: 'lp' },
  HII: { viewMode: 'star', recommendedFilter: 'lp' },
  Neb: { viewMode: 'star', recommendedFilter: 'lp' },
  EmN: { viewMode: 'star', recommendedFilter: 'lp' },
  RfN: { viewMode: 'star', recommendedFilter: 'lp' },
  DrkN: { viewMode: 'star', recommendedFilter: 'clear' },
  SNR: { viewMode: 'star', recommendedFilter: 'lp' },
  '*Ass': { viewMode: 'star', recommendedFilter: 'clear' },
  Nova: { viewMode: 'star', recommendedFilter: 'clear' },
  Other: { viewMode: 'star', recommendedFilter: 'clear' },
}
