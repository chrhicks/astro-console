...
export function evaluateSiteDiagnostics(site: Pick<SiteProfile, "name" | "lon" | "timezone">): SiteDiagnostic[] {
...
function readTimeZoneOffsetHours(timeZone: string, at: Date): number | undefined {
  try {
