...
Status: **one ordered Epic; read-only preflight, guided polar alignment, target acquisition, and pointing-correction verification are complete; live frame evidence is next**
