...
This directory preserves superseded reasoning for targeted historical lookup.
Do not include it in default V2 context and do not use an archived statement
to override `docs/v2/current/`, accepted gate records, or the current UI and UX
direction.
...
- [Phase 0.5 design-system archive](phase-0.5/README.md) — completed visual
  audits, bridge material, and closeout rationale.
- [Retired Astro Console UI and UX authority](ui-authority-2026-08-08/README.md)
  — former local UX guidance, visual guide, component library, build contract,
  UX catalog, and component grammar superseded by the official Nightbook demo
  direction.
