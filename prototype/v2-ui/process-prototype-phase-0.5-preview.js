(() => {
  ...
  const els = {
    scenario: document.querySelector("[data-scenario-control]") || { value: "", add() {}, addEventListener() {} }, runbar: document.querySelector("[data-runbar]"), content: document.querySelector("[data-process-content]"),
